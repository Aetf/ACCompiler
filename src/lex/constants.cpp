...
std::ostream& operator<<(std::ostream &os, const token_id &id)
{
    switch(id)
    {
        ...
        case token_id::OP_AND: return os << "OP_AND";
        case token_id::OP_OR: return os << "OP_OR";
        case token_id::OP_NOT: return os << "OP_NOT";
        ...
        case token_id::OP_LPAREN: return os << "OP_LPAREN";
        case token_id::OP_RPAREN: return os << "OP_RPAREN";
